...
mr = function(a, b, c, d) {
    ...
    mr = function(a, b, c, d) {
        ...
        a.scroll = {},
            ...
            a.scroll.x = 0;
        var e = function(b) {
            b("body").hasClass("scroll-assist") && (a.scroll.assisted = !0),
                addEventListener("scroll", function(a) {
                    c.mr.scroll.y = c.pageYOffset,
                        c.mr.scroll.update(a)
                }, !1)
        };
        return a.scroll.update = function(b) {
            for (var c = 0, d = a.scroll.listeners.length; d > c; c++)
                a.scroll.listeners[c](b)
        }
            ,
            a.scroll.documentReady = e,
            a.components.documentReady.push(e),
            a
    }(mr, jQuery, window, document),
    mr = function(a, b, c, d) {
        "use strict";
        a.scroll.classModifiers = {},
            ...
            a.scroll.classModifiers.parseScrollRules = function(b) {
                ...
                return d.forEach(function(c) {
                    var d, e, f = {};
                    if (d = c.replace(/\s/g, "").split(":"),
                        2 === d.length) {
                        if (e = a.util.parsePixels(d[0]),
                                !(e > -1))
                            return !1;
                        if (f.scrollPoint = e,
                                !d[1].length)
            ...
            a.scroll.classModifiers.update = function(b) {
                for (var c, d = a.scroll.y, e = a.scroll.classModifiers.rules, f = e.length; f--; )
                    c = e[f],
                    d > c.scrollPoint && !c.hasClass && (c.element.classList.add(c.toggleClass),
                        c.hasClass = a.scroll.classModifiers.rules[f].hasClass = !0),
                    d < c.scrollPoint && c.hasClass && (c.element.classList.remove(c.toggleClass),
    ...
    mr = function(a, b, c, d) {
        ...
        return a.cookies = {
            ...
            setItem: function(a, b, c, e, f, g) {
                ...
                return d.cookie = encodeURIComponent(a) + "=" + encodeURIComponent(b) + h + (f ? "; domain=" + f : "") + (e ? "; path=" + e : "") + (g ? "; secure" : ""),
                    !0
            },
            removeItem: function(a, b, c) {
                return this.hasItem(a) ? (d.cookie = encodeURIComponent(a) + "=; expires=Thu, 01 Jan 1970 00:00:00 GMT" + (c ? "; domain=" + c : "") + (b ? "; path=" + b : ""),
                    !0) : !1
            },
            hasItem: function(a) {
    ...
    mr = function(a, b, c, d) {
        ...
        var e = function(a) {
            a(".countdown[data-date]").each(function() {
                var b, c = a(this), d = c.attr("data-date"), e = "days";
                "undefined" != typeof c.attr("data-date-fallback") && (b = c.attr("data-date-fallback")),
                "undefined" != typeof c.attr("data-days-text") && (e = c.attr("data-days-text")),
                    c.countdown(d, function(a) {
        ...
        return a.countdown = {
            ...
            a.components.documentReadyDeferred.push(e),
            a
    }(mr, jQuery, window, document),
    mr = function(a, b, c, d) {
        "use strict";
        ...
        return a.components.documentReady.push(e),
            a
    }(mr, jQuery, window, document),
    mr = function(a, b, c, d) {
        "use strict";
        function e(a) {
            a(".dropdown__container").each(function() {
                var a = jQuery(this)
                    ...
                    , e = "";
                a.css("left", -b + c),
                a.find('.dropdown__content:not([class*="md-12"])').length && (e = a.find(".dropdown__content"),
                    e.css("left", d - c))
            }),
        ...
        function f(a) {
            ...
            a(".dropdown__container").each(function() {
                var a = jQuery(this)
                    ...
                    , f = "";
                a.css("right", -c + d),
                a.find('.dropdown__content:not([class*="md-12"])').length && (f = a.find(".dropdown__content"),
                    f.css("right", e - d))
            }),
                a(".dropdown__content").each(function() {
                    var a = jQuery(this)
        ...
        var g = function(b) {
            var g = !1;
            b('html[dir="rtl"]').length && (g = !0),
            a.dropdowns.done || (jQuery(d).on("click", "body:not(.dropdowns--hover) .dropdown:not(.dropdown--hover), body.dropdowns--hover .dropdown.dropdown--click", function(a) {
                var c = jQuery(this);
                jQuery(a.target).is(".dropdown--active > .dropdown__trigger") ? (c.siblings().removeClass("dropdown--active").find(".dropdown").removeClass("dropdown--active"),
                    c.toggleClass("dropdown--active")) : (b(".dropdown--active").removeClass("dropdown--active"),
                    c.addClass("dropdown--active"))
            }),
                ...
                a.dropdowns.done = !0),
                g === !1 ? e(b) : f(b),
                jQuery(c).resize(function() {})
        };
        return a.dropdowns.documentReady = g,
            a.components.documentReady.push(g),
            a
    }(mr, jQuery, window, document),
    mr = function(a, b, c, d) {
        "use strict";
        ...
        var e = function(b) {
            b(".input-checkbox").on("click", function() {
                ...
                var c = a.find("input");
                return c.prop("checked") === !1 ? c.prop("checked", !0) : c.prop("checked", !1),
                    !1
            }),
                b(".input-radio").on("click", function(a) {
                    if (!b(a.target).is("input")) {
                        ...
                        return c.closest("form").find("[type=radio][name=" + d + "]").each(function() {
                            b(this).parent().removeClass("checked")
                        }),
                            c.addClass("checked").find("input").click().prop("checked", !0),
                            !1
                    }
                }),
                b(".input-number__controls > span").on("click", function() {
                    ...
                    b.is("[data-step]") && (f = parseInt(b.attr("data-step"), 10)),
                        a.hasClass("input-number__increase") ? d >= g + f && c.attr("value", g + f) : g - f >= e && c.attr("value", g - f)
                }),
        ...
        return a.forms.documentReady = e,
            a.forms.submit = function(d) {
                d.preventDefault ? d.preventDefault() : d.returnValue = !1;
                var e, f, g, h, i, j = b("body"), k = b(d.target).closest("form"), l = "undefined" != typeof k.attr("action") ? k.attr("action") : "", m = k.find('button[type="submit"], input[type="submit"]'), n = 0, o = k.attr("original-error");
                if (j.find(".form-error, .form-success").remove(),
                        m.attr("data-text", m.text()),
                        h = k.attr("data-error") ? k.attr("data-error") : "Please fill all fields correctly",
                        i = k.attr("data-success") ? k.attr("data-success") : "Thanks, we'll be in touch shortly",
                    ...
                    if ("undefined" != typeof o && o !== !1 && f.html(o),
                        1 !== a.forms.validateFields(k)) {
                        ...
                        try {
                            b.ajax({
                                ...
                                success: function(b) {
                                    "success" !== b.result && 200 !== b.Status ? (f.attr("original-error", f.text()),
                                        f.html(b.msg).stop(!0).fadeIn(1e3),
                                        g.stop(!0).fadeOut(1e3),
                                        m.removeClass("btn--loading")) : (m.removeClass("btn--loading"),
                                        e = k.attr("data-success-redirect"),
                                        "undefined" != typeof e && e !== !1 && "" !== e ? c.location = e : (a.forms.resetForm(k),
                                            a.forms.showFormSuccess(g, f, 1e3, 5e3, 500)))
                                }
                            })
                        } catch (p) {
                    ...
                    "undefined" != typeof o && o !== !1 && f.text(o),
                        ...
                        1 === n ? a.forms.showFormError(g, f, 1e3, 5e3, 500) : (k.removeClass("attempted-submit"),
                            f.fadeOut(200),
                            m.addClass("btn--loading"),
                            jQuery.ajax({
                                type: "POST",
                                ...
                                success: function(d) {
                                    m.removeClass("btn--loading"),
                                        b.isNumeric(d) ? parseInt(d, 10) > 0 && (e = k.attr("data-success-redirect"),
                                            "undefined" != typeof e && e !== !1 && "" !== e && (c.location = e),
                                                a.forms.resetForm(k),
                                                a.forms.showFormSuccess(g, f, 1e3, 5e3, 500)) : (f.attr("original-error", f.text()),
                                            f.text(d).stop(!0).fadeIn(1e3),
                                            g.stop(!0).fadeOut(1e3))
                                },
            ...
            a.forms.validateFields = function(a) {
                ...
                if (a = b(a),
                        a.find('.validate-required[type="checkbox"]').each(function() {
                            var a = b(this);
                            b('[name="' + b(this).attr("name") + '"]:checked').length || (e = 1,
                                c = b(this).attr("data-name") || "check",
                                a.parent().addClass("field-error"))
                        }),
                        a.find(".validate-required, .required, [required]").not('input[type="checkbox"]').each(function() {
                            "" === b(this).val() ? (b(this).addClass("field-error"),
                                e = 1) : b(this).removeClass("field-error")
                        }),
                        a.find('.validate-email, .email, [name*="cm-"][type="email"]').each(function() {
                            /(.+)@(.+){2,}\.(.+){2,}/.test(b(this).val()) ? b(this).removeClass("field-error") : (b(this).addClass("field-error"),
                                e = 1)
                        }),
                        a.find(".validate-number-dash").each(function() {
                            /^[0-9][0-9-]+[0-9]$/.test(b(this).val()) ? b(this).removeClass("field-error") : (b(this).addClass("field-error"),
                                e = 1)
                        }),
    ...
    mr = function(a, b, c, d) {
        ...
        var e = function(a) {
            a("[data-gradient-bg]").each(function(b, c) {
                var d, e, f, g = a(this), h = "granim-" + b, i = g.attr("data-gradient-bg"), j = [], k = [];
                if (g.prepend('<canvas id="' + h + '"></canvas>'),
                        e = /^(#[0-9|a-f|A-F]{6}){1}([ ]*,[ ]*#[0-9|a-f|A-F]{6})*$/.test(i),
                    e === !0)
                    for (i = i.replace(" ", ""),
                             i = i.split(","),
                             d = i.length,
    ...
    mr = function(a, b, c, d) {
        ...
        var e = function(a) {
            if (a(".instafeed").length) {
                var b, c, d = "4079540202.b9b1d8a.1d13c245c68d4a17bfbff87919aaeb14", e = "b9b1d8ae049d4153b24a6332f0088686";
                a(".instafeed[data-access-token][data-client-id]").length && (b = a(".instafeed[data-access-token][data-client-id]").first().attr("data-access-token"),
                    c = a(".instafeed[data-access-token][data-client-id]").first().attr("data-client-id"),
                "" !== b && (d = b),
                "" !== c && (e = c)),
            ...
            a(".instafeed").each(function() {
                var b = a(this)
                    ...
                    , d = 12;
                "undefined" != typeof b.attr("data-amount") && (d = parseInt(b.attr("data-amount"), 10)),
                    b.append("<ul></ul>"),
                    b.children("ul").spectragram("getUserFeed", {
                        query: c,
                        max: d
                    })
            })
    ...
    mr = function(a, b, c, d) {
        ...
        var e = function(b) {
            ...
            c.length && (c.addClass("gmaps-active"),
                a.maps.initAPI(b),
                a.maps.init())
        };
        return a.maps.documentReady = e,
            a.maps.initAPI = function(a) {
                if (d.querySelector("[data-maps-api-key]") && !d.querySelector(".gMapsAPI") && a("[data-maps-api-key]").length) {
                    ...
                    c = "undefined" != typeof c ? c : "",
                    "" !== c && (b.type = "text/javascript",
                        b.src = "https://maps.googleapis.com/maps/api/js?key=" + c + "&callback=mr.maps.init",
            ...
            a.maps.init = function() {
                "undefined" != typeof c.google && "undefined" != typeof c.google.maps && jQuery(".gmaps-active").each(function() {
                    var a, b, e = this, f = jQuery(this), g = "undefined" != typeof f.attr("data-map-style") ? f.attr("data-map-style") : !1, h = JSON.parse(g) || [{
                        ...
                        }], i = "undefined" != typeof f.attr("data-map-zoom") && "" !== f.attr("data-map-zoom") ? 1 * f.attr("data-map-zoom") : 17, j = "undefined" != typeof f.attr("data-latlong") ? f.attr("data-latlong") : !1, k = j ? 1 * j.substr(0, j.indexOf(",")) : !1, l = j ? 1 * j.substr(j.indexOf(",") + 1) : !1, m = new google.maps.Geocoder, n = "undefined" != typeof f.attr("data-address") ? f.attr("data-address").split(";") : [""], o = "undefined" != typeof f.attr("data-marker-image") ? f.attr("data-marker-image") : "img/mapmarker.png", p = "We Are Here", q = jQuery(d).width() > 766 ? !0 : !1, r = {
                        draggable: q,
                        scrollwheel: !1,
                        zoom: i,
                        disableDefaultUI: !0,
                    ...
                    "undefined" != typeof f.attr("data-marker-title") && "" !== f.attr("data-marker-title") && (p = f.attr("data-marker-title")),
                        void 0 !== n && "" !== n[0] ? m.geocode({
                            address: n[0].replace("[nomarker]", "")
                        }, function(a, b) {
                            if (b === google.maps.GeocoderStatus.OK) {
                                var d = new google.maps.Map(e,r);
                                d.setCenter(a[0].geometry.location),
    ...
    mr = function(a, b, c, d) {
        ...
        var e = function(b) {
            b(".masonry").each(function() {
                var c, d = b(this), e = d.find(".masonry__container"), f = d.find(".masonry__filters"), g = "undefined" != typeof f.attr("data-filter-all-text") ? f.attr("data-filter-all-text") : "All";
                e.find(".masonry__item[data-masonry-filter]").length && (f.append("<ul></ul>"),
                    c = f.find("> ul"),
                    e.find(".masonry__item[data-masonry-filter]").each(function() {
                        var d = b(this)
                            , e = d.attr("data-masonry-filter")
                            , f = [];
                        "undefined" != typeof e && "" !== e && (f = e.split(",")),
                            jQuery(f).each(function(b, e) {
                                var f = a.util.slugify(e);
                                d.addClass("filter-" + f),
                                c.find('[data-masonry-filter="' + f + '"]').length || c.append('<li data-masonry-filter="' + f + '">' + e + "</li>")
                            })
                    }),
                    a.util.sortChildrenByText(b(this).find(".masonry__filters ul")),
                    c.prepend('<li class="active" data-masonry-filter="*">' + g + "</li>"))
            }),
            ...
            b(".masonry").each(function() {
                var a = b(this).find(".masonry__container")
                    , c = b(this)
                    , d = "*";
                c.is("[data-default-filter]") && (d = c.attr("data-default-filter").toLowerCase(),
                    d = ".filter-" + d,
                    c.find("li[data-masonry-filter]").removeClass("active"),
                    c.find('li[data-masonry-filter="' + c.attr("data-default-filter").toLowerCase() + '"]').addClass("active")),
        ...
        return a.masonry = {
            ...
            a.components.documentReady.push(e),
            a.components.windowLoad.push(f),
            a
    }(mr, jQuery, window, document),
    mr = function(a, b, c, d) {
        "use strict";
        ...
        return a.modals.documentReady = e,
            a.modals.showModal = function(a, b) {
    ...
    mr = function(a, b, c, d) {
            ...
            b('form[action*="createsend.com"]').each(function() {
                c = b(this),
                    ...
                    c.is(".form--no-placeholders") ? c.find("input[placeholder]").removeAttr("placeholder") : c.find("input:not([checkbox]):not([radio])").each(function() {
                        var a = b(this);
                        "undefined" != typeof a.attr("placeholder") ? "" === a.attr("placeholder") && a.siblings("label").length && (a.attr("placeholder", a.siblings("label").first().text()),
                            c.is(".form--no-labels") && a.siblings("label").first().remove()) : a.siblings("label").length && (a.attr("placeholder", a.siblings("label").first().text()),
                    ...
                    c.find('input[type="checkbox"]').each(function() {
                        d = b(this),
                            ...
                            b('.input-checkbox[data-id="' + f + '"]').prepend('<div class="inner"></div>')
                    }),
                    ...
                    c.is(".form--no-labels") && c.find("input:not([checkbox]):not([radio])").each(function() {
                        ...
                        c.find('input[type="checkbox"]').each(function() {
                            d = b(this),
                                g = d.parent(),
                                e = g.find("label"),
                                d.before('<div class="input-checkbox"><div class="inner"></div></div>'),
                        ...
                        c.find('input[type="radio"]').each(function() {
                            h = b(this),
                                g = h.closest("li"),
                                e = g.find("label"),
                                h.before('<div class="input-radio"><div class="inner"></div></div>'),
        ...
        return a.newsletters.documentReady = e,
            a.newsletters.prepareAjaxAction = function(a) {
                ...
                /list-manage\.com/.test(c) && (c = c.replace("/post?", "/post-json?") + "&c=?",
                "//" === c.substr(0, 2) && (c = "http:" + c)),
    ...
    mr = function(a, b, c, d) {
        ...
        return a.notifications.documentReady = e,
            a.notifications.showNotification = function(b, c) {
                var d = "undefined" != typeof c ? 1 * c : 0;
                if (setTimeout(function() {
                        b.addClass("notification--reveal"),
                            b.closest("nav").addClass("notification--reveal"),
                        b.find("input").length && b.find("input").first().focus()
                    }, d),
                        b.is("[data-autohide]")) {
            ...
            a.notifications.closeNotification = function(c) {
                var d = jQuery(c);
                c = d.is(".notification") ? d : d.is(".notification-close") ? d.closest(".notification") : b('.notification[data-notification-link="' + c + '"]'),
    ...
    mr = function(a, b, c, d) {
        ...
        var e = function(a) {
            ...
            if (/Android|iPhone|iPad|iPod|BlackBerry|Windows Phone/i.test(navigator.userAgent || navigator.vendor || c.opera) && a("section").removeClass("parallax"),
                d > 768) {
    ...
    mr = function(a, b, c, d) {
        ...
        var e = function(b) {
            a.easypiecharts.init = function() {
                ...
                a.easypiecharts.activate = function() {
                    a.easypiecharts.pies.forEach(function(b) {
                        Math.round(a.scroll.y + a.window.height) >= Math.round(b.top + b.height) && b.active === !1 && (b.element.data("easyPieChart").enableAnimation(),
                            b.element.data("easyPieChart").update(b.value),
                            b.element.addClass("radial--active"),
                            b.active = !0)
                    })
                }
                ,
                b(".radial").each(function() {
                    var a = jQuery(this)
                        ...
                        , d = 110
                        , e = 3;
                    "undefined" != typeof a.attr("data-timing") && (c = 1 * a.attr("data-timing")),
                    "undefined" != typeof a.attr("data-color") && (b = a.attr("data-color")),
                    "undefined" != typeof a.attr("data-size") && (d = a.attr("data-size")),
                    "undefined" != typeof a.attr("data-bar-width") && (e = a.attr("data-bar-width")),
                        a.css("height", d).css("width", d),
                        a.easyPieChart({
                            animate: {
                                duration: c,
                                enabled: !0
            ...
            b(".radial").length && (a.easypiecharts.init(),
                a.easypiecharts.activate(),
                a.scroll.listeners.push(a.easypiecharts.activate))
        };
        return a.easypiecharts.documentReady = e,
            a.components.documentReadyDeferred.push(e),
            a
    }(mr, jQuery, window, document),
    mr = function(a, b, c, d) {
        ...
        var e = function(b) {
            b(".slider").each(function(c) {
                ...
                g = "true" === d.attr("data-arrows") ? !0 : !1,
                    j = "false" === d.attr("data-autoplay") ? !1 : !0,
                    h = "true" === d.attr("data-paging") && e.find("li").length > 1 ? !0 : !1,
                d.attr("data-timing") && (i = 1 * d.attr("data-timing")),
        ...
        return a.sliders.documentReady = e,
            a.components.documentReadyDeferred.push(e),
            a
    }(mr, jQuery, window, document),
    mr = function(a, b, c, d) {
        ...
        a.smoothscroll = {},
                ...
                a.smoothscroll.sections = [],
                    b("a.inner-link").each(function() {
                        var c = {}
                            ...
                            , e = d.attr("href")
                            , f = new RegExp("^#[^\n^s^#^.]+$");
                        f.test(e) && b("section" + e).length && (c.id = e,
                            c.top = Math.round(b(e).offset().top),
                            c.height = Math.round(b(e).outerHeight()),
                            c.link = d.get(0),
                            c.active = !1,
                            a.smoothscroll.sections.push(c))
                    }),
            ...
            a.smoothscroll.highlight = function() {
                a.smoothscroll.sections.forEach(function(b) {
                    a.scroll.y >= b.top && a.scroll.y < b.top + b.height ? b.active === !1 && (b.link.classList.add("inner-link--active"),
                            b.active = !0) : (b.link.classList.remove("inner-link--active"),
                        b.active = !1)
                })
            }
            ,
        ...
        var e = function(b) {
            ...
            if (d.length) {
                d.each(function(a) {
                    ...
                    a.smoothscroll.init(),
                    b(c).on("resize", a.smoothscroll.init);
                var e = 0;
                b("body[data-smooth-scroll-offset]").length && (e = b("body").attr("data-smooth-scroll-offset"),
                    e = 1 * e),
                    smoothScroll.init({
                        selector: ".inner-link",
                        selectorHeader: null,
        ...
        return a.smoothscroll.documentReady = e,
            a.components.documentReady.push(e),
    ...
    mr = function(a, b, c, d) {
        ...
        var e = function(a) {
            a(".tabs").each(function() {
                var b = a(this);
                b.after('<ul class="tabs-content">'),
                    b.find("li").each(function() {
                        var b = a(this)
                            , c = b.find(".tab__content").wrap("<li></li>").parent()
                            , d = c.clone(!0, !0);
                        c.remove(),
                            b.closest(".tabs-container").find(".tabs-content").append(d)
                    })
            }),
                a(".tabs li").on("click", function() {
                    var b, c = a(this), d = c.closest(".tabs-container"), e = 1 * c.index() + 1, f = d.find("> .tabs-content > li:nth-of-type(" + e + ")");
                    d.find("> .tabs > li").removeClass("active"),
                        d.find("> .tabs-content > li").removeClass("active"),
                        c.addClass("active"),
                        f.addClass("active"),
                        b = f.find("iframe"),
                    b.length && b.attr("src", b.attr("src"))
                }),
                ...
                a(c).each(function() {
                    ...
                    2 === d.length && (f = d[0],
                        ...
                        a(c).on("click", function() {
                            return c.hasClass("toggled-class") || c.toggleClass("toggled-class"),
                                a(f).toggleClass(e),
                                !1
                        }))
                })
        ...
        var e = function(b) {
            b(".tweets-feed").each(function(a) {
                ...
                function d(b) {
                    ...
                    return f += "</ul>",
                        e.html(f),
                        e.closest(".slider").length ? (a.sliders.documentReady(a.setContext()),
                            f) : void 0
                }
                var e = b("#tweets-" + c)
                    , f = {
    ...
    mr = function(a, b, c, d) {
        ...
        var e = function(a) {
            a(".youtube-background").length && a(".youtube-background").each(function() {
                ...
                b.attr("data-property", '{videoURL:"' + c + '",containment:"self",autoPlay:true, mute:true, startAt:' + d + ", opacity:1}"),
                    b.closest(".videobg").append('<div class="loading-indicator"></div>'),
                    b.YTPlayer(),
                    b.on("YTPStart", function() {
                        b.closest(".videobg").addClass("video-active")
                    })
            }),
            a(".videobg").find("video").length && a(".videobg").find("video").closest(".videobg").addClass("video-active"),
                a(".video-cover").each(function() {
                    var b = a(this);
                    b.find("iframe").length && (b.find("iframe").attr("data-src", b.find("iframe").attr("src")),
